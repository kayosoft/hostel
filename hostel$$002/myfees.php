				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<span>
							...
							<input type="submit" name="" class="btn btn-primary btn-block" value="Pay Through MTN momo" style="background-color: yellow; color: black; font-weight: 30px; font-size: 2rem;" >
							</form>
						</span>
